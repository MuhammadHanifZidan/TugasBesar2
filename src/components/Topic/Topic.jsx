...
const Topic = () => {
  ...
  const swimmingImageRef = useRef(null);
  const swimmingTextRef = useRef(null);
  const trekkingTextRef = useRef(null);
  const trekkingImageRef = useRef(null);

  useEffect(() => {
    const elements = [
      titleRef.current,
      lineRef.current,
      swimmingImageRef.current,
      swimmingTextRef.current,
      trekkingTextRef.current,
      trekkingImageRef.current
    ].filter(Boolean);
      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            if (entry.target === topicRef.current) {
  ...
  return (
    <div className='wrapper' ref={topicRef}>
      ...
      <div className="container">
        <div className="topic-image" ref={swimmingImageRef}>
          <img src={Swimming} alt="Swimming at Curug Leuwi Hejo" />
        </div>
        <div className="topics" ref={swimmingTextRef}>
          <p>
        ...
        <div className="topics" ref={trekkingTextRef}>
          <p>
        ...
        <div className="topic-image" ref={trekkingImageRef}>
